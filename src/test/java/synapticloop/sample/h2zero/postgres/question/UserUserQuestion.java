package synapticloop.sample.h2zero.postgres.question;
...
public class UserUserQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(UserUserQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_user_user = ?";
	 ...
	 * 
	 * @param idUserUser The primary key for this model
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idUserUser) {
