package synapticloop.sample.h2zero.postgres.model;
...
import synapticloop.sample.h2zero.postgres.question.UserTypeQuestion;
import synapticloop.h2zero.base.validator.*;
import synapticloop.h2zero.base.model.postgresql.ModelBase;
...
import synapticloop.sample.h2zero.postgres.finder.UserUserFinder;
...
public class UserUser extends ModelBase {
	...
	public static final String PRIMARY_KEY_FIELD = "id_user_user";
...
// Static lookups for fields in the hit counter.
	...
	private Timestamp tsSignup = null;
	...
	public String toString() {
		...
		stringBuilder.append("Model[UserUser]\n");
		...
		stringBuilder.append("  Field[tsSignup:" + this.tsSignup + "]\n");
	...
	public JSONObject toJSON() {
		...
		ModelBaseHelper.addtoJSONObject(jsonObject, "tsSignup", this.getTsSignup());
		return(jsonObject);
	}
