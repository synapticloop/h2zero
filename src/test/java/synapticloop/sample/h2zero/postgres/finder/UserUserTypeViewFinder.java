...
import synapticloop.sample.h2zero.postgres.view.UserUserType;
...
public class UserUserTypeViewFinder {
	 ...
	 */
	public static UserUserType findByPrimaryKey(Connection connection, Long idUserUserPet) throws H2ZeroFinderException {
	 ...
	 * @throws H2ZeroFinderException if one couldn't be found
	 */
	public static UserUserType findByPrimaryKey(Long idUserUserPet) throws H2ZeroFinderException {
		UserUserType userUserType = null;
		...
		try {
			...
			userUserType = findByPrimaryKey(connection, idUserUserPet);
		} catch (SQLException sqlex) {
			throw new H2ZeroFinderException(sqlex);
		} catch (H2ZeroFinderException h2zfex) {
			throw new H2ZeroFinderException(h2zfex.getMessage() + "  Additionally, the parameters were [idUserUserPet:" + idUserUserPet + "].");
	 ...
	 * 
	 */
	public static UserUserType findByPrimaryKeySilent(Connection connection, Long idUserUserPet) {
		try {
	 ...
	 * 
	 */
	public static UserUserType findByPrimaryKeySilent(Long idUserUserPet) {
		try {
