...
import synapticloop.sample.h2zero.finder.UserTitleFinder;
...
public class FindIdUserTitleNmUserTitleOrderedTag extends BaseVarTag {
	...
	private static final Logger LOGGER = LogManager.getLogger(FindIdUserTitleNmUserTitleOrderedTag.class);
