 ...
 *  <li><code>img_photo</code> (varchar)  nullable </li>
 * </ul>
 * 
...
public class PetInserter {
	 ...
	 */
	public static int insert(Connection connection, Long idPet, String nmPet, Integer numAge, Float fltWeight, Date dtBirthday, String imgPhoto) throws SQLException {
		int numResults = -1;
	 ...
	 * @throws SQLException if there was an error in the SQL insert statement
	 */
	public static int insert(Long idPet, String nmPet, Integer numAge, Float fltWeight, Date dtBirthday, String imgPhoto) throws SQLException {
		int numResults = -1;
	 ...
	 * @return the number of rows that were inserted, or -1 if an error occurred
	 */
	public static int insertSilent(Connection connection, Long idPet, String nmPet, Integer numAge, Float fltWeight, Date dtBirthday, String imgPhoto) {
		int numResults = -1;
		try {
			numResults = insert(connection, idPet, nmPet, numAge, fltWeight, dtBirthday, imgPhoto);
		} catch (SQLException sqlex) {
	 ...
	 * @return the number of rows that were inserted, or -1 if an error occurred
	 */
	public static int insertSilent(Long idPet, String nmPet, Integer numAge, Float fltWeight, Date dtBirthday, String imgPhoto) {
		int numResults = -1;
		Connection connection = null;
		try {
			connection = ConnectionManager.getConnection();
