...
public class AuthorDeleter {
	...
	public static int deleteByPrimaryKey(Long idAuthor) throws SQLException {
		...
		int numResults = deleteByPrimaryKey(connection, idAuthor);
	...
	public static int deleteByPrimaryKeySilent(Connection connection, Long idAuthor) {
		int numResults = 0;
		try {
			numResults = deleteByPrimaryKey(connection, idAuthor);
	...
	public static int deleteByPrimaryKeySilent(Long idAuthor) {
		...
		try {
			...
			numResults = deleteByPrimaryKeySilent(connection, idAuthor);
		} catch (SQLException sqlex) {
			LOGGER.error("Could not deleteByPrimaryKey, a SQL Exception occured.", sqlex);
			return(-1);
		} finally {
