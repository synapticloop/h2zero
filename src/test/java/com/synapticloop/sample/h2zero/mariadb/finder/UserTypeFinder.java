...
import com.synapticloop.sample.h2zero.mariadb.model.UserType;
...
public class UserTypeFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@5655e168</code> table or view by its primary key.</p>
	 * 
