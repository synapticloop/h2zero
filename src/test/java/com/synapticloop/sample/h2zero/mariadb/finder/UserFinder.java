...
public class UserFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@57c4ee7b</code> table or view by its primary key.</p>
	 * 
