...
import com.synapticloop.sample.h2zero.mariadb.view.UserUserType;
...
public class UserUserTypeViewFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.View@7620522a</code> table or view by its primary key.</p>
	 * 
	 ...
	 * 
	 * @param nmUsername - maps to the <code>USER_USER_TYPE.nm_username</code> field
	 * 
	 * @return the parameterised MultiFinder()
	 * 
	 */
