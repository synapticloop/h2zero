...
/**
 * <p>The <code>UserUserPetCounter</code> contains all Counter methods for the <code>user_user_pet</code> table.</p>
 * 
 * <p>The following user-defined Counters have been defined:
 * 
 * 
 * <table border="1" cellspacing="0" cellpadding="4">
 *   <caption>Details for the user_user_pet table</caption>
 *   <thead>
 *     <tr>
 *       <th>Name</th>
 *       <th>Type</th>
...
public class UserUserPetCounter {
	...
	/**
	 * Find the count of all UserUserPet objects
	 * 
	 * @param connection the passed in connection object, useful for queries within
	 * a transaction.
	 * 
	 * @return the count of UserUserPet objects
	 * 
	...
	/**
	 * <p>Find the count of the rows of the UserUserPet table.</p>
	 * 
	 * <p>This will execute the following SQL Statement:</p>
	 * 
	 * <pre>
	 * select count(*) from user_user_pet
	 * </pre>
	 * 
	 ...
	 * a transaction.
	 * 
	 * @return the count of the rows of the UserUserPet table, or -1 if there
	...
	/**
	 * Find the count of all UserUserPet objects and if there is an error
