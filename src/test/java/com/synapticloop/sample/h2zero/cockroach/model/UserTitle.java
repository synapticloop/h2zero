...
public class UserTitle extends ConstantModelBase {
	...
	public static final String PARAM_ID_USER_TITLE = "idUserTitle"; // static String for the name of the id_user_title
	public static final String PARAM_NM_USER_TITLE = "nmUserTitle"; // static String for the name of the nm_user_title
	public static final String PARAM_NUM_ORDER_BY = "numOrderBy"; // static String for the name of the num_order_by
	 ...
	 * 
	 * <p>Instantiating a new UserTitle:</p>
	 * 
	 * <pre>new UserTitle(
	...
	public JSONObject toJSON() {
		...
		ModelBaseHelper.addToJSONObject(fieldsObject, PARAM_ID_USER_TITLE, this.getIdUserTitle());
		ModelBaseHelper.addToJSONObject(fieldsObject, PARAM_NM_USER_TITLE, this.getNmUserTitle());
		ModelBaseHelper.addToJSONObject(fieldsObject, PARAM_NUM_ORDER_BY, this.getNumOrderBy());
