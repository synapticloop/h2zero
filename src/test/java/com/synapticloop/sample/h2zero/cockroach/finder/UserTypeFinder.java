...
public class UserTypeFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@3ccc9c04</code> table or view by its primary key.</p>
	 * 
