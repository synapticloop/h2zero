...
/**
 * <p>This is the deleter for the <code>user_user_pet</code> table and contains in-built
 * methods to delete all and delete by primary key.</p>
 * 
 * @author Synapticloop
 */
public class UserUserPetDeleter {
	...
	// static SQL Strings generated by synapticloop h2zero

	private static final String SQL_BUILTIN_DELETE_ALL = "truncate table user_user_pet";
