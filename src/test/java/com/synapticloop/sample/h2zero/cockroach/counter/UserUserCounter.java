...
/**
 * <p>The UserUserCounter contains all counters that are defined
 * in the h2zero file for the <code>user_user</code> table.  These counters
 ...
 *
 * <pre>UserUserCounter.counterName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class UserUserCounter {
	...
	/**
	 * <p>Create a counter for the <code>UserUser</code> database	 * table that will count all results.</p>
	 * 
