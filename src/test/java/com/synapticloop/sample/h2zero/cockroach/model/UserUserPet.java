...
public class UserUserPet extends ModelBase {
	...
	private static final String TABLE_JAVA_NAME = "$UserUserPet";
	private static final String TABLE_NAME = "$user_user_pet";
	...
	public static final String PARAM_ID_USER_USER_PET = "idUserUserPet"; // static String for the name of the id_user_user_pet
	public static final String PARAM_ID_USER_USER = "idUserUser"; // static String for the name of the id_user_user
	 ...
	 * 
	 * <p>Instantiating a new UserUserPet:</p>
	 * 
	 * <pre>new UserUserPet(
	 ...
	 * UserUserPet model.</p>
	 * 
	 * <p>If the passed in userUserPet is null, then a new UserUserPet will
	 ...
	 * is set, then this UserUserPet Object has been persisted to the database. 
	 * </p>
	 * 
	...
	/**
	 * <p>Insert the UserUserPet object into the database, setting the 
	...
	/**
	 * <p>Ensure that the UserUserPet object with all fields exist 
	 * in the database.</p>
	 *
	 * @param connection The connection to use for this insert
	 *
	 ...
	 * 
	 * @param idUserUserPet The primary key field to update
	 */
	...
	public JSONObject toJSON() {
		...
		ModelBaseHelper.addToJSONObject(fieldsObject, PARAM_ID_USER_USER_PET, this.getIdUserUserPet());
		ModelBaseHelper.addToJSONObject(fieldsObject, PARAM_ID_USER_USER, this.getIdUserUser());
	...
	public static String getHitCountJson() {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put(JSON_KEY_TYPE, "UserUserPet");
		jsonObject.put(JSON_KEY_TOTAL, HIT_COUNTS[0]);
		jsonObject.put(PARAM_ID_USER_USER_PET, HIT_COUNTS[1]);
		jsonObject.put(PARAM_ID_USER_USER, HIT_COUNTS[2]);
