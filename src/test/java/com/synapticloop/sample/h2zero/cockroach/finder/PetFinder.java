...
public class PetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@1df9c5eb</code> table or view by its primary key.</p>
	 * 
