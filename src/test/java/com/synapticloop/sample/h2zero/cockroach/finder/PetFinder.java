...
public class PetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@b57631d</code> table or view by its primary key.</p>
	 * 
