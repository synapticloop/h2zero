 ...
 *
 * <pre>AuthorQuestion.questionName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class AuthorQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AuthorQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_author = ?";
	 ...
	 * 
	 * @param idAuthor The primary key for this model.
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idAuthor) {
