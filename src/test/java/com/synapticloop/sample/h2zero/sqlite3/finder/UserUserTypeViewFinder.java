...
public class UserUserTypeViewFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.View@31b4472e</code> table or view by its primary key.</p>
	 * 
