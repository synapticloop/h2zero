...
/**
 * <p>This is the deleter for the <code>author</code> table and contains in-built
...
public class AuthorDeleter {
	 ...
	 *        this method.
	 * @param flIsUpdating - maps to the <code>fl_is_updating</code> field (from the where clause)
	 * @param flIsUpdatingList - maps to the <code>fl_is_updating</code> field (from the where clause)
	 * @param dtmStartedFollowingList - maps to the <code>dtm_started_following</code> field (from the where clause)
	 * @param flIsUpdatingOne - maps to the <code>fl_is_updating</code> field (from the where clause)
	 * @param flIsUpdatingTwo - maps to the <code>fl_is_updating</code> field (from the where clause)
	 * 
	 * @return the number of rows deleted
	 * 
