...
public class PetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@7e3146be</code> table or view by its primary key.</p>
	 * 
