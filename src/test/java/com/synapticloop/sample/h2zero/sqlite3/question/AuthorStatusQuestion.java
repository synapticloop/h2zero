package com.synapticloop.sample.h2zero.sqlite3.question;

// - - - - thoughtfully generated by synapticloop h2zero - - - - 
//    with the use of synapticloop templar templating language
//             (/java/java-create-question.templar)
...
import com.synapticloop.h2zero.base.sql.limitoffset.Question;
 ...
 * 
 * <p>Table name: <code>author_status</code></p>
 * 
 * 
 ...
 *
 * <pre>AuthorStatusQuestion.questionName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
 ...
 */
public class AuthorStatusQuestion {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AuthorStatusQuestion.class);


	// this is an internal SQL question select statement used by the validator
	private static final String SQL_INTERNAL_DOES_PRIMARY_KEY_EXIST = "SELECT (COUNT(*) = 1) WHERE id_author_status = ?";
	 ...
	 * 
	 * @param idAuthorStatus The primary key for this model.
	 * 
	 * @return whether the primary key exists
	 */
	public static boolean internalDoesPrimaryKeyExist(Long idAuthorStatus) {
