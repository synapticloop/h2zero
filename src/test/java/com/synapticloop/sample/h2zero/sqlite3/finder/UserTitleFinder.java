...
public class UserTitleFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@7cd7c80c</code> table or view by its primary key.</p>
	 * 
