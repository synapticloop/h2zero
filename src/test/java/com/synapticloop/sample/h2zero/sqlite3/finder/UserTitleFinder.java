...
public class UserTitleFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@f72c29e</code> table or view by its primary key.</p>
	 * 
