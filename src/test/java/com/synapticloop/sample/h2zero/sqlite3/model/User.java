...
import com.synapticloop.sample.h2zero.sqlite3.question.UserTypeQuestion;
...
public class User extends ModelBase {
	...
	public void insert(Connection connection) throws SQLException, H2ZeroPrimaryKeyException {
		...
		try {
			...
			C3P0ConnectionManager.setDatetime(preparedStatement, 7, dtmSignup);
	...
	protected void hydrate(Connection connection) throws SQLException, H2ZeroPrimaryKeyException {
		...
		try {
			...
			this.dtmSignup = C3P0ConnectionManager.getNullableResultTimestamp(resultSet, 2);
