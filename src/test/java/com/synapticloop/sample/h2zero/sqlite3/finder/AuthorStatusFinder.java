...
public class AuthorStatusFinder {
	...
	/**
	 * <p>Create a UniqueFinder that can find a AuthorStatus by its primary key</p>
	 * 
	 ...
	 * 
	 * <pre>AuthorStatus.findByPrimaryKey(primaryKey)
	 ...
	 */
	public static UniqueFinder<AuthorStatus> findByPrimaryKey(Long idAuthorStatus) {
		return(new UniqueFinder<AuthorStatus>(
				LOGGER,
	...
	/**
	 * <p>Create a MultiFinder that can find all AuthorStatus rows</p>
	 * <p>
	 * <p>This will return a UniqueFinder, to execute the finder, either call</p>
	 * 
	 * <ul>
	 ...
	 */
	public static MultiFinder<AuthorStatus> findAll() {
		return(
				new MultiFinder<AuthorStatus>(
				LOGGER,
				SQL_SELECT_START,
				resultSet -> { try {return list(resultSet);} catch (SQLException e) { return(null); }},
				new Object[] {}
