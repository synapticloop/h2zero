...
public class AuthorStatusFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@625e061b</code> table or view by its primary key.</p>
	 * 
