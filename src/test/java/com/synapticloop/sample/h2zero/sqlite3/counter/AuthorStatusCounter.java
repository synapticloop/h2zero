...
/**
 * <p>The AuthorStatusCounter contains all counters that are defined
 * in the h2zero file for the <code>author_status</code> table.  These counters
 ...
 *
 * <pre>AuthorStatusCounter.counterName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class AuthorStatusCounter {
	...
	/**
	 * <p>Create a counter for the <code>AuthorStatus</code> database	 * table that will count all results.</p>
	 * 
