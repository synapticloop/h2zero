...
public class AllTypes extends ModelBase {
	...
	public static final int HIT_TEST_BOOLEAN = 3; // The number of hits on the test_boolean property
	public static final int HIT_TEST_DATE = 4; // The number of hits on the test_date property
	public static final int HIT_TEST_DATETIME = 5; // The number of hits on the test_datetime property
	public static final int HIT_TEST_DOUBLE = 6; // The number of hits on the test_double property
	public static final int HIT_TEST_FLOAT = 7; // The number of hits on the test_float property
	public static final int HIT_TEST_INT = 8; // The number of hits on the test_int property
	public static final int HIT_TEST_INTEGER = 9; // The number of hits on the test_integer property
	public static final int HIT_TEST_MEDIUMINT = 10; // The number of hits on the test_mediumint property
	public static final int HIT_TEST_NUMERIC = 11; // The number of hits on the test_numeric property
	public static final int HIT_TEST_SMALLINT = 12; // The number of hits on the test_smallint property
	public static final int HIT_TEST_TEXT = 13; // The number of hits on the test_text property
	public static final int HIT_TEST_TINYINT = 14; // The number of hits on the test_tinyint property
	public static final int HIT_TEST_VARCHAR = 15; // The number of hits on the test_varchar property
