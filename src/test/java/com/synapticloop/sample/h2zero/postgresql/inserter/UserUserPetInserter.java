...
public class UserUserPetInserter {
	...
	/**
	 * <p>Insert a new <code>UserUserPet</code> into the database utilising the passed in connection.</p>
	 * 
	...
	/**
	 * <p>Insert a new UserUserPet into the database a new connection will be retrieved 
