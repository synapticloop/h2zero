...
public class PetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@2fe84096</code> table or view by its primary key.</p>
	 * 
