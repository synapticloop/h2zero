...
public class UserUserPetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>user_user_pet</code> table or view by its primary key.</p>
	 * 
	 ...
	 * 
	 * <pre>UserUserPetFinder.findByPrimaryKey(primaryKey)
	 ...
	 * 
	 * <ul>
	 *   <li>Return a <code>UserUserPet</code> object, or</li>
	...
	/**
	 * <p>Return the results as a list of UserUserPet, this will be empty if
	 * none are found.</p>
	 * 
