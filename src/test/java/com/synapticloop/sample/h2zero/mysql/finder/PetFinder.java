...
public class PetFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@2d2602b1</code> table or view by its primary key.</p>
	 * 
