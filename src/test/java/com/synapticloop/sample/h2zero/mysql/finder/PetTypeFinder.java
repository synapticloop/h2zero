...
public class PetTypeFinder {
	...
	/**
	 * <p>Create a Finder that can find a unique row of the <code>com.synapticloop.h2zero.generator.model.Table@35b0a50b</code> table or view by its primary key.</p>
	 * 
