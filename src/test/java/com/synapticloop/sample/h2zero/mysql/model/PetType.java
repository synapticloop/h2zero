...
public class PetType extends ModelBase {
	...
	public static final int HIT_ID_PET_TYPE = 1; // The number of hits on the id_pet_type property
	public static final int HIT_NM_PET_TYPE = 2; // The number of hits on the nm_pet_type property
	public static final int HIT_TXT_DESC_PET_TYPE = 3; // The number of hits on the txt_desc_pet_type property
	...
	/**
	 * <p>Create a new <code>PetType</code> object with all fields
	 ...
	 *     String nmPetType,  // nm_pet_type 
	 *     String txtDescPetType // txt_desc_pet_type 
	 * );</pre>
	 * 
	 */
	...
	/**
	 * <p>Convenience method for returning the primary key field (which is the id_pet_type field).</p>
	 * 
	...
	/**
	 * <p>Set the primary key field (which is the id_pet_type field).</p>
	 * 
