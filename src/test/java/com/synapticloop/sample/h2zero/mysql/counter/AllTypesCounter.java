 ...
 *
 * <pre>AllTypesCounter.counterName(parameter1, parameter2, ...)
 *          .execute();
 * </pre>
 *
...
public class AllTypesCounter {
	...
	/**
	 * <p>Create a counter for the <code>AllTypes</code> database	 * table that will count all results.</p>
	 * 
