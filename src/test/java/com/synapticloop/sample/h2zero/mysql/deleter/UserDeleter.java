...
/**
 * <p>This is the deleter for the <code>user</code> table and contains in-built
...
public class UserDeleter {
	...
	// The table has foreign keys that point to it, so the faster table 'truncate' SQL is not valid
	...
	/**
	 * <p>deleteByNumAge - from 'fieldDeleters' JSON key</p>
	 *
	 * <p>This is the main method for all other deleter methods with the same prefix,
	 * including the (silent method signatures).  All methods chain to this one.</p>
	 * 
	 ...
	 *        this method.
	 * @param numAge - maps to the <code>num_age</code> field (from the where clause)
	...
	// USER DEFINED DELETER CONNECTION, PARAMS, LIMIT
	/**
	 * <p>deleteByFlIsAliveIdUserType - from 'fieldDeleters' JSON key</p>
	 *
	 * <p>This is the main method for all other deleter methods with the same prefix,
	 * including the (silent method signatures).  All methods chain to this one.</p>
	 * 
	 ...
	 *        null, then a new connection will be created, utilised, and closed within
	 *        this method.
	 * @param flIsAlive - maps to the <code>fl_is_alive</code> field (from the where clause)
	 * @param idUserType - maps to the <code>id_user_type</code> field (from the where clause)
	 * @param limit - The limit of the number of rows to affect
	 * 
	 * @return the number of rows deleted
	 * 
	...
	// USER DEFINED DELETER CONNECTION, PARAMS, LIMIT
	/**
	 * <p>deleteByNumAgeTest - from 'deleters' JSON key</p>
	 *
	 * <p>This is the main method for all other deleter methods with the same prefix,
	 * including the (silent method signatures).  All methods chain to this one.</p>
	 * 
