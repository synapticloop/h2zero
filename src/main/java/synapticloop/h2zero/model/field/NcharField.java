...
public class NcharField extends BaseField {

	public NcharField(JSONObject jsonObject) throws H2ZeroParseException {
		super(jsonObject);
	}

	public NcharField(JSONObject jsonObject, boolean isInField) throws H2ZeroParseException {
