...
public class IntegerField extends BaseField {
	...
	public IntegerField(JSONObject jsonObject) throws H2ZeroParseException {
		super(jsonObject);
	}

	public IntegerField(JSONObject jsonObject, boolean isInField) throws H2ZeroParseException {
