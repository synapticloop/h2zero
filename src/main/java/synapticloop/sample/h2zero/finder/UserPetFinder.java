...
public class UserPetFinder {
	 ...
	 */
	public static UserPet findByPrimaryKey(Connection connection, Long idUserPet) throws H2ZeroFinderException, SQLException {
	 ...
	 * @throws SQLException if there was an error in the SQL statement
	 */
	public static UserPet findByPrimaryKey(Long idUserPet) throws H2ZeroFinderException, SQLException {
		UserPet userPet = null;
	...
	public static UserPet findByPrimaryKeySilent(Connection connection, Long idUserPet) {
		try {
			...
			if(LOGGER.isEnabledFor(Level.WARN)) {
				LOGGER.warn("SQLException findByPrimaryKeySilent(" + idUserPet + "): " + sqlex.getMessage());
				if(LOGGER.isEnabledFor(Level.DEBUG)) {
