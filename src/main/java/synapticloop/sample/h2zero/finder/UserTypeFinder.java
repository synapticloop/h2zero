...
public class UserTypeFinder {
	 ...
	 */
	public static UserType findByPrimaryKey(Connection connection, Long idUserType) throws H2ZeroFinderException, SQLException {
	 ...
	 * @throws SQLException if there was an error in the SQL statement
	 */
	public static UserType findByPrimaryKey(Long idUserType) throws H2ZeroFinderException, SQLException {
		UserType userType = null;
	...
	public static UserType findByPrimaryKeySilent(Connection connection, Long idUserType) {
		try {
			...
			if(LOGGER.isEnabledFor(Level.WARN)) {
				LOGGER.warn("SQLException findByPrimaryKeySilent(" + idUserType + "): " + sqlex.getMessage());
				if(LOGGER.isEnabledFor(Level.DEBUG)) {
