...
public class PetFinder {
	 ...
	 */
	public static Pet findByPrimaryKey(Connection connection, Long idPet) throws H2ZeroFinderException, SQLException {
		Pet pet = null;
	 ...
	 * @throws SQLException if there was an error in the SQL statement
	 */
	public static Pet findByPrimaryKey(Long idPet) throws H2ZeroFinderException, SQLException {
		Pet pet = null;
	...
	public static Pet findByPrimaryKeySilent(Connection connection, Long idPet) {
		try {
			...
			if(LOGGER.isEnabledFor(Level.WARN)) {
				LOGGER.warn("SQLException findByPrimaryKeySilent(" + idPet + "): " + sqlex.getMessage());
				if(LOGGER.isEnabledFor(Level.DEBUG)) {
