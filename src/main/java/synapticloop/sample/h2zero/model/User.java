...
import synapticloop.sample.h2zero.finder.UserTypeFinder;
...
public class User extends ModelBase {
	...
	private boolean[] populated = {false, false, false, false, false, false, false, false };
	...
	public void refresh() throws H2ZeroPrimaryKeyException {
		...
		User user = UserFinder.findByPrimaryKeySilent(this.idUser);
	...
	public void setIdUserType(Long idUserType) {if(isDifferent(this.idUserType, idUserType)) {this.idUserType = idUserType;this.isDirty = true;this.userType = null;}}
	public Boolean getFlIsAlive() {return(this.flIsAlive);}
	...
	public String getTxtAddressEmail() {return(this.txtAddressEmail);}
	...
	public String getTxtPassword() {return(this.txtPassword);}
