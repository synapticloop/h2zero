...
public class NvarcharField extends BaseField {

	public NvarcharField(JSONObject jsonObject) throws H2ZeroParseException {
		super(jsonObject);
	}

	public NvarcharField(JSONObject jsonObject, boolean isInField) throws H2ZeroParseException {
