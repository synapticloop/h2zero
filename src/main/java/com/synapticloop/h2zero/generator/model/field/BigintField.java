...
public class BigintField extends BaseField {

  public BigintField(JSONObject jsonObject) throws H2ZeroParseException {
    super(jsonObject);
  }

  public BigintField(JSONObject jsonObject, boolean isInField) throws H2ZeroParseException {
  ...
  @Override public String getSqlJavaType() {
    return ("Long");
  }

  @Override public String getSqlNullType() {
    return ("BIGINT");
  }
