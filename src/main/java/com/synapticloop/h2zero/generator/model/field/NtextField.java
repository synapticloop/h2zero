...
public class NtextField extends BaseField {

	public NtextField(JSONObject jsonObject) throws H2ZeroParseException {
		super(jsonObject);
	}

	public NtextField(JSONObject jsonObject, boolean isInField) throws H2ZeroParseException {
	...
	@Override public String getSqlTestValue() { return("\"Ntext\""); }
