package com.synapticloop.h2zero.base.finder.offsetfetch;
...
import com.synapticloop.h2zero.base.finder.BaseUniqueFinder;
...
public class UniqueFinder<T> extends BaseUniqueFinder<T> {
	...
	@Override protected String getLimitedResultsStatement() {
		return(super.getOffsetFetchStatementInternal());
	}
}
