...
public abstract class BaseIntegerNoLimitOffsetExecutor extends BaseSQLNoLimitOffsetExecutor {
	public BaseIntegerNoLimitOffsetExecutor(Logger logger, String sqlStatement, Object... parameters) {
	...
	protected Integer executeInternal() throws SQLException, H2ZeroFinderException {
		...
		String preparedStatementTemp = sqlStatement;
