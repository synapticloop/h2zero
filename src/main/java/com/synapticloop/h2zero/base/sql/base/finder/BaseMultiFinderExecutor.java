...
public abstract class BaseMultiFinderExecutor<T> extends BaseFinderExecutor<T> {
	 ...
	 */
	public BaseMultiFinderExecutor(Logger logger, String sqlStatement, Function<ResultSet, List<T>> resultsFunction, Object ... parameters) {
	 ...
	 */
	public BaseMultiFinderExecutor<T> withOffset(Integer offset) {
		this.offset = offset;
		return(this);
	}
	 ...
	 */
	public BaseMultiFinderExecutor<T> withLimit(Integer limit) {
		this.limit = limit;
		return(this);
	}
	 ...
	 */
	public BaseMultiFinderExecutor<T> withConnection(Connection connection) {
