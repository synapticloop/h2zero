...
public abstract class OffsetFetchDeleter extends BaseIntegerFinder {
	public OffsetFetchDeleter(Logger logger, String sqlStatement, Function<ResultSet, Integer> resultsFunction, Object... parameters) {
