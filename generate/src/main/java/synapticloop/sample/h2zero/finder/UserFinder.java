...
public class UserFinder {
	...
	private static Map<String, String> findByNumAgeIn_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findAll_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByNumAge_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByFlIsAliveNumAge_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByNmUsername_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByTxtAddressEmail_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByTxtAddressEmailTxtPassword_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByNumAgeIn_limit_statement_cache = new HashMap<String, String>();
	private static Map<String, String> findByNumAgeBetween_limit_statement_cache = new HashMap<String, String>();
	private UserFinder() {}
	...
	public static List<FindNmUserDtmSignupBean> findNmUserDtmSignupSilent(Connection connection) {
		try {
			return(findNmUserDtmSignup(connection));
		} catch(H2ZeroFinderException h2zfex) {
			if(LOGGER.isEnabledFor(Level.WARN)) {
				LOGGER.warn("H2ZeroFinderException findNmUserDtmSignupSilent(): " + h2zfex.getMessage());
				if(LOGGER.isEnabledFor(Level.DEBUG)) {
	...
	public static List<FindGroupNumAgeBean> findGroupNumAgeSilent(Connection connection) {
		try {
			return(findGroupNumAge(connection));
		} catch(H2ZeroFinderException h2zfex) {
			if(LOGGER.isEnabledFor(Level.WARN)) {
				LOGGER.warn("H2ZeroFinderException findGroupNumAgeSilent(): " + h2zfex.getMessage());
				if(LOGGER.isEnabledFor(Level.DEBUG)) {
