...
public class User extends ModelBase {
	...
	public Long getPrimaryKey() { updateHitCount(0 + 1);return(this.idUser); }
	...
	public Long getIdUser() { updateHitCount(0 + 1); return(this.idUser); }
	public void setIdUser(Long idUser) { if(isDifferent(this.idUser, idUser)) { this.idUser = idUser;this.isDirty = true; }}
	public Long getIdUserType() { updateHitCount(1 + 1); return(this.idUserType); }
	...
	public Boolean getFlIsAlive() { updateHitCount(2 + 1); return(this.flIsAlive); }
	...
	public Integer getNumAge() { updateHitCount(3 + 1); return(this.numAge); }
	public void setNumAge(Integer numAge) { if(isDifferent(this.numAge, numAge)) { this.numAge = numAge;this.isDirty = true; }}
	public String getNmUsername() { updateHitCount(4 + 1); return(this.nmUsername); }
	...
	public String getTxtAddressEmail() { updateHitCount(5 + 1); return(this.txtAddressEmail); }
	...
	public String getTxtPassword() { updateHitCount(6 + 1); return(this.txtPassword); }
	...
	public Timestamp getDtmSignup() { updateHitCount(7 + 1); return(this.dtmSignup); }
