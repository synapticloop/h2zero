...
public class UserPet extends ModelBase {
	...
	public Long getPrimaryKey() { updateHitCount(0 + 1);return(this.idUserPet); }
	...
	public Long getIdUserPet() { updateHitCount(0 + 1); return(this.idUserPet); }
